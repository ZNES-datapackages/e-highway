...
def create_resource(path):
    ...
    resource.descriptor['description'] = 'Electricity load profiles per country'
    resource.descriptor['title'] = 'Electricity load profiles'
...
path = building.write_sequences('electricity-load-profiles.csv', sequences_df)
